...
public class ViewCorreio extends javax.swing.JFrame implements Viewable {
    ...
    private void jTabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaMouseClicked
        if (jTabela.getSelectedRow() != -1) {
            String selectedIdCorreio = jTabela.getValueAt(jTabela.getSelectedRow(),0).toString();
            String selectedCodigoDocumento = jTabela.getValueAt(jTabela.getSelectedRow(),1).toString().replace("-", "");
            String selectedIdMorador = jTabela.getValueAt(jTabela.getSelectedRow(),2).toString();

            jTId.setText(selectedIdCorreio);
            jTCodigoDocumento.setText(selectedCodigoDocumento);
            jTIdMorador.setText(selectedIdMorador);
        }
