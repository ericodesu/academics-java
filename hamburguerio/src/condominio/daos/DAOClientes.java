...
import condominio.models.ModelCliente;
 ...
 */
public class DAOClientes implements CRUDable<ModelCliente> {
    @Override
    public void Inserir(ModelCliente modelo) {
        try {
            String query = "INSERT INTO clientes (nome,cpf,telefone,email,endereco,forma_pagamento) VALUES (?,?,?,?,?,?)";
            ...
            this._stmt.setString(5, modelo.getEndereco());
    ...
    public void Alterar(ModelCliente modelo) {
        try {
            String query = "UPDATE clientes SET nome=?,cpf=?,telefone=?,email=?,endereco=?,forma_pagamento=? WHERE id_cliente=?";
            ...
            this._stmt.setString(5, modelo.getEndereco());
            this._stmt.setString(6, modelo.getFormaPagamento());
            this._stmt.setInt(7, modelo.getIdCliente());
